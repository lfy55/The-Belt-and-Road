...
window.onload = function () {
    ...
    function init() {
        ...
        $.getJSON("data/world.json", function (json) {
            ...
            globe.add(new THREE.Mesh(
                new THREE.SphereGeometry(globeSize * 1.2, 32, 32),
    ...
    function addLinks(type, chosenCountry) {
        ...
        if (chosenCountry) $("#" + chosenCountry).css({
            'font-size': 24,
            'color': '#FFFFFF',
            'z-index': 4,
            'opacity': 1
    ...
    function StoryLine() {
        ...
        var story = [{
                ...
                "setup": "wind",
                "delay": 3,
                "title": "THE GLOBE OF ECONOMIC COMPLEXITY",
                "subtitle": "This site visualizes the economies of each country as told by the products they export."
            },
            {
                "div": 2,
                "setup": "step3",
                "delay": 4,
                "title": "This is the world economy",
                "subtitle": "Every pixel is a different product"
            },
            {
                "div": 3,
                "setup": "hide",
                "delay": 3,
                "title": "Consider a Swiss watch",
                "subtitle": "The average Swiss watch costs $685"
            },
            {
                "div": 4,
                "setup": "centroids3D",
                "delay": 5,
                "title": "Each dot represents $100 million of trade",
                "subtitle": "The equivalent of 150000 swiss watches"
            },
            {
                "div": 5,
                "setup": "gridSphere",
                "delay": 5,
                "title": "Colors represent an industry",
                "subtitle": "Watches represent 5% of Swiss exports"
            },
            {
                "div": 6,
                "setup": "gridSphere",
                "delay": 4,
                "title": "Here are Switzerland's top 10 trade partners",
                "subtitle": "With $263 billion of goods in total"
            },
            {
                "div": 7,
                "setup": "gridmap",
                "delay": 4,
                "title": "Not all countries have the capacity to export in all sectors",
                "subtitle": "Compare <span style='color:#17becf'>machinery (engines, intergrated circuits, telephones)</span> with <span style='color:#FFC41C'>vegetables (coffee, soya beans, wheat)</span>"
            },
            {
                "div": 8,
                "setup": "productsphere",
                "delay": 4,
                "title": "Products rely on different productive capabilities.",
                "subtitle": "Some industries have products that have a lot of connections such as <span style='color:#17becf'>machinery</span>, as opposed to <span style='color:#FFC41C'>vegetables</span>.<br/>We call this the product space."
            },
            {
                "div": 9,
                "setup": "gridSphere",
                ...
                "subtitle": "This site allows you to explore the productive similarities of products and countries."
            }
        ];
