(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["dcharts"] = factory();
	else
		root["dcharts"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Export dcharts as CommonJS module
	 */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * LICENSE
	 * https://github.com/ecomfe/dcharts/blob/master/LICENSE.txt
	 */
	 ...
	 */
	    ...
	    function ECharts (dom, theme, opts) {
	        ...
	        /**
	         * @type {Array.<module:dcharts/view/Chart>}
	         * @private
	         */
	        this._chartsViews = [];

	        /**
	         * @type {Object.<string, module:dcharts/view/Chart>}
	         * @private
	         */
	        this._chartsMap = {};

	        /**
	         * @type {Array.<module:dcharts/view/Component>}
	         * @private
	         */
	        this._componentsViews = [];

	        /**
	         * @type {Object.<string, module:dcharts/view/Component>}
	         * @private
	         */
	        this._componentsMap = {};

	        /**
	         * @type {module:dcharts/ExtensionAPI}
	         * @private
	         */
	        this._api = new ExtensionAPI(this);

	        /**
	         * @type {module:dcharts/CoordinateSystem}
	         * @private
	         */
	        ...
	        /**
	         * @type {module:dcharts~MessageCenter}
	         * @private
	         */
	    ...
	    /**
	     * @return {module:dcharts/model/Global}
	     */
	     ...
	     * @param  {module:dcharts/model/Global} ecModel
	     * @private
	     */
	     ...
	     * @param {module:dcharts/model/Series|module:dcharts/model/Component} model
	     * @param {module:dcharts/view/Component|module:dcharts/view/Chart} view
	     */
	     ...
	     * @param {Object} opts
	     */
	    dcharts.init = function (dom, theme, opts) {
	        if (true) {
	            // Check version
	            if ((zrender.version.replace('.', '') - 0) < (dcharts.dependencies.zrender.replace('.', '') - 0)) {
	                throw new Error(
	                    'ZRender ' + zrender.version
	                    + ' is too old for ECharts ' + dcharts.version
	                    + '. Current version need ZRender '
	                    + dcharts.dependencies.zrender + '+'
	                );
	            }
	            if (!dom) {
	    ...
	    /**
	     * @return {string|Array.<module:dcharts~ECharts>} groupId
	     */
	    dcharts.connect = function (groupId) {
	        // Is array of charts
	     ...
	     */
	    dcharts.disConnect = function (groupId) {
	        connectedGroups[groupId] = false;
	    };

	    /**
	     * Dispose a chart instance
	     * @param  {module:dcharts~ECharts|HTMLDomElement|string} chart
	     */
	    dcharts.dispose = function (chart) {
	        if (zrUtil.isDom(chart)) {
	            chart = dcharts.getInstanceByDom(chart);
	        }
	    ...
	    /**
	     * @param  {HTMLDomElement} dom
	     * @return {dcharts~ECharts}
	     */
	    dcharts.getInstanceByDom = function (dom) {
	     ...
	     * @return {dcharts~ECharts}
	     */
	    dcharts.getInstanceById = function (key) {
	        return instances[key];
	    };
	     ...
	     * Register theme
	     */
	    dcharts.registerTheme = function (name, theme) {
	     ...
	     */
	    dcharts.registerPreprocessor = function (preprocessorFunc) {
	     ...
	     */
	    dcharts.registerProcessor = function (priority, processorFunc) {
	     ...
	     */
	    dcharts.registerAction = function (actionInfo, eventName, action) {
	     ...
	     */
	    dcharts.registerCoordinateSystem = function (type, CoordinateSystem) {
	     ...
	     */
	    dcharts.registerLayout = function (priority, layoutFunc) {
	        if (typeof priority === 'function') {
	            layoutFunc = priority;
	     ...
	     */
	    dcharts.registerVisual = function (priority, visualFunc) {
	        if (typeof priority === 'function') {
	            visualFunc = priority;
	     ...
	     */
	    dcharts.extendComponentModel = function (opts, superClass) {
	     ...
	     * @param {string} [superClass]
	     */
	    dcharts.extendComponentView = function (opts, superClass) {
	     ...
	     * @param {string} [superClass]
	     */
	    dcharts.extendSeriesModel = function (opts, superClass) {
	     ...
	     * @param {string} [superClass]
	     */
	    dcharts.extendChartView = function (opts, superClass) {
	        var Clazz = ChartView;
	        if (superClass) {
	     ...
	     *     var dcharts = require('dcharts');
	     *     dcharts.setCanvasCreator(function () {
	     *         // Small size is enough.
	     *         return new Canvas(32, 32);
	     *     });
	     */
	    dcharts.setCanvasCreator = function (creator) {
	        zrUtil.createCanvas = creator;
	    };

	    dcharts.registerVisual(PRIORITY_VISUAL_GLOBAL, __webpack_require__(94));
	    dcharts.registerPreprocessor(__webpack_require__(95));

	    // Default action
	    dcharts.registerAction({
	        type: 'highlight',
	        event: 'highlight',
	        update: 'highlight'
	    }, zrUtil.noop);
	    ...
	    // --------
	    //
	    dcharts.List = __webpack_require__(97);
	    dcharts.Model = __webpack_require__(12);

	    dcharts.graphic = __webpack_require__(43);
	    dcharts.number = __webpack_require__(7);
	    dcharts.format = __webpack_require__(6);
	    dcharts.matrix = __webpack_require__(11);
	    dcharts.vector = __webpack_require__(10);
	    dcharts.color = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:dcharts/model/Global
	     *
	     * @param {Object} option
	     * @param {module:dcharts/model/Model} parentModel
	     * @param {Object} theme
	     */
	    var GlobalModel = Model.extend({
	        ...
	        init: function (option, parentModel, theme, optionManager) {
	            ...
	            /**
	             * @type {module:dcharts/model/Model}
	             * @private
	             */
	            this._theme = new Model(theme);

	            /**
	             * @type {module:dcharts/model/OptionManager}
	             */
	        ...
	        /**
	         * @return {module:dcharts/model/Model}
	         */
	        getTheme: function () {
	            return this._theme;
	        },
	         ...
	         * @param {number} [idx=0]
	         * @return {module:dcharts/model/Component}
	         */
	         ...
	         * @return {Array.<module:dcharts/model/Component>}
	         */
	        ...
	        /**
	         * @param {string} name
	         * @return {Array.<module:dcharts/model/Series>}
	         */
	         ...
	         * @return {module:dcharts/model/Series}
	         */
	        ...
	        /**
	         * @param {module:dcharts/model/Series} seriesModel
	         */
	    ...
	    function initBase(baseOption) {
	        ...
	        /**
	         * @type {Object.<string, Array.<module:dcharts/model/Model>>}
	         * @private
	         */
	        this._componentsMap = {};
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        // in dcharts. id can be specified by user, or auto generated.
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     * @param {module:dcharts/data/List} data
	     * @param {Object} opt
	     ...
	     *
	     * @public
	     * @param {Array.<Object>|Array.<module:dcharts/model/Component>} exists
...
/***/ function(module, exports) {
	 ...
	 */
	     ...
	     * @memberOf module:dcharts/util/number
	     * @param  {(number|Array.<number>)} val
	    ...
	    number.linearMap = function (val, domain, range, clamp) {
	        ...
	        // See dcharts/test/ut/spec/util/number.js#linearMap#accuracyError
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	/**
	 * @module dcharts/core/BoundingRect
	 */
	    ...
	    var mathMax = Math.max;
	    /**
	     * @alias module:dcharts/core/BoundingRect
	     */
	    ...
	    BoundingRect.prototype = {
	        ...
	        /**
	         * @param {module:dcharts/core/BoundingRect} other
	         */
	        ...
	        /**
	         * @param {(module:dcharts/core/BoundingRect|Object)} b
	         * @return {boolean}
	         */
	        ...
	        /**
	         * @return {module:dcharts/core/BoundingRect}
	         */
	        clone: function () {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:dcharts/model/Model
	     * @constructor
	     * @param {Object} option
	     * @param {module:dcharts/model/Model} [parentModel]
	     * @param {module:dcharts/model/Global} [ecModel]
	    ...
	    function Model(option, parentModel, ecModel) {
	        ...
	        /**
	         * @type {module:dcharts/model/Global}
	         * @readOnly
	         */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Component model
	 *
	 * @module dcharts/model/Component
	 */
	    ...
	    /**
	     * @alias module:dcharts/model/Component
	     * @constructor
	     * @param {Object} option
	     * @param {module:dcharts/model/Model} parentModel
	     * @param {module:dcharts/model/Model} ecModel
	     */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * @module {dcharts/model/OptionManager}
	 */
	     ...
	     * [rawOption]:
	     *
	     *     An object input to dcharts.setOption. 'rawOption' may be an
	     ...
	     *     };
	     *
	     * @alias module:dcharts/model/OptionManager
	     * @param {module:dcharts/ExtensionAPI} api
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var SeriesModel = ComponentModel.extend({
	        ...
	        // coodinateSystem will be injected in the dcharts/CoordinateSystem
	        ...
	        init: function (option, parentModel, ecModel, extraOpt) {
	            ...
	            /**
	             * @type {module:dcharts/data/List|module:dcharts/data/Tree|module:dcharts/data/Graph}
	             * @private
	             */
	            ...
	            // module:dcharts/data/Graph or module:dcharts/data/Tree.
	            // See module:dcharts/data/helper/linkList
	        ...
	        /**
	         * @param {string} [dataType]
	         * @return {module:dcharts/data/List}
	         */
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * @module dcharts/animation/Animator
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	     ...
	     * @param {module:dcharts/model/Model} labelModel
	     * @param {string} color
	     */
	     ...
	     * @param {module:zrender/Element} el
	     * @param {Object} props
	     * @param {module:dcharts/model/Model} [animatableModel]
	     * @param {number} [dataIndex]
	     * @param {Function} [cb]
	     * @example
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @constructor
	     * @alias module:dcharts/data/List
	     *
	     * @param {Array.<string>} dimensions
	     *        Dimensions should be concrete names like x, y, z, lng, lat, angle, radius
	     * @param {module:dcharts/model/Model} hostModel
	     */
	    var List = function (dimensions, hostModel) {
	         ...
	         * @type {Array.<module:dcharts/model/Model>}
	         * @private
	         */
	        this._optionModels = [];

	        /**
	         * @param {module:dcharts/data/List}
	         */
	        this.stackedOn = null;
	            ...
	            for (var i = 0, len = this.count(); i < len; i++) {
	                ...
	                if (
	                    ...
	                    && (dist < minDist
	                        ...
	                        // https://github.com/ecomfe/dcharts/issues/2869
	                        || (dist === minDist && diff > 0)
	                    )
	                ) {
	                    minDist = dist;
	     ...
	     * @param {module:dcharts/data/List} otherList
	     * @return {module:dcharts/data/DataDiffer}
	     */
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(4);
	    var dcharts = __webpack_require__(1);
	    var PRIORITY = dcharts.PRIORITY;

	    __webpack_require__(100);
	    __webpack_require__(103);

	    dcharts.registerVisual(zrUtil.curry(
	        __webpack_require__(109), 'line', 'circle', 'line'
	    ));
	    dcharts.registerLayout(zrUtil.curry(
	        __webpack_require__(110), 'line'
	    ));

	    // Down sample after filter
	    dcharts.registerProcessor(PRIORITY.PROCESSOR.STATISTIC, zrUtil.curry(
...
/***/ function(module, exports, __webpack_require__) {
	...
	// FIXME step not support polar
	    ...
	    /**
	     * @param {module:dcharts/coord/cartesian/Cartesian2D|module:dcharts/coord/polar/Polar} coordSys
	     * @param {module:dcharts/data/List} data
	    ...
	    module.exports = ChartView.extend({
	        ...
	        _getSymbolIgnoreFunc: function (data, coordSys) {
	            ...
	            // `getLabelInterval` is provided by dcharts/component/axis
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * @module dcharts/chart/helper/SymbolDraw
	 */
	    ...
	    /**
	     * @constructor
	     * @alias module:dcharts/chart/helper/SymbolDraw
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * @module dcharts/chart/helper/Symbol
	 */
	    ...
	    /**
	     * @constructor
	     * @alias {module:dcharts/chart/helper/Symbol}
	     * @param {module:dcharts/data/List} data
	     * @param {number} idx
...
/***/ function(module, exports, __webpack_require__) {
	...
	var factory = exports;
	    ...
	    function Grid(gridModel, ecModel, api) {
	        /**
	         * @type {Object.<string, module:dcharts/coord/cartesian/Cartesian2D>}
	         * @private
	         */
	        this._coordsMap = {};

	        /**
	         * @type {Array.<module:dcharts/coord/cartesian/Cartesian>}
	         * @private
	         */
	        this._coordsList = [];

	        /**
	         * @type {Object.<string, module:dcharts/coord/cartesian/Axis2D>}
	         * @private
	         */
	        this._axesMap = {};

	        /**
	         * @type {Array.<module:dcharts/coord/cartesian/Axis2D>}
	         * @private
	         */
	        this._axesList = [];
	    ...
	    /**
	     * Resize the grid
	     * @param {module:dcharts/coord/cartesian/GridModel} gridModel
	     * @param {module:dcharts/ExtensionAPI} api
	     */
	     ...
	     * @param  {module:dcharts/model/Option} option
	     * @private
	     */
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * @param {module:dcharts/model/Model} model
	     * @param {string} [axisType] Default retrieve from model.type
	     * @return {module:dcharts/scale/*}
	     */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @module dcharts/coord/scale/Ordinal
	 *
	...
	// FIXME only one data
	    ...
	    /**
	     * @return {module:dcharts/scale/Time}
	     */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:dcharts/coord/scale/Interval
	     * @constructor
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Interval scale
	 * @module dcharts/coord/scale/Time
	 */
	    ...
	    /**
	     * @alias module:dcharts/coord/scale/Time
	     * @constructor
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    Cartesian2D.prototype = {
	         ...
	         *
	         * @return {module:dcharts/coord/cartesian/Axis2D}
	         */
	        getBaseAxis: function () {
	        ...
	        /**
	         * Get other axis
	         * @param {module:dcharts/coord/cartesian/Axis2D} axis
	         */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @module  dcharts/coord/Cartesian
	 *
	 */
	    ...
	    /**
	     * @alias module:dcharts/coord/Cartesian
	     * @constructor
	     */
	    ...
	    Cartesian.prototype = {
	         ...
	         * @return {module:dcharts/coord/Cartesian~Axis}
	         */
	        ...
	        /**
	         * Get axes list
	         * @return {Array.<module:dcharts/coord/Cartesian~Axis>}
	         */
	        getAxes: function () {
	        ...
	        /**
	         * Add axis
	         * @param {module:dcharts/coord/Cartesian.Axis}
	         */
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * Extend axis 2d
	     * @constructor module:dcharts/coord/cartesian/Axis2D
	     * @extends {module:dcharts/coord/cartesian/Axis}
	     * @param {string} dim
	     * @param {*} scale
	    ...
	    Axis2D.prototype = {
	        ...
	        /**
	         * Axis model
	         * @param {module:dcharts/coord/cartesian/AxisModel}
	         */
	        model: null,
	         ...
	         * designate by module:dcharts/coord/cartesian/Grid.
	         * @type {Function}
	         */
	        toLocalCoord: null,
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * @name module:dcharts/coord/CartesianAxis
	     * @constructor
	     */
	    var Axis = function (dim, scale, extent) {
	        ...
	        /**
	         * Axis scale
	         * @type {module:dcharts/coord/scale/*}
	         */
	        this.scale = scale;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 所以这里也要被 Cartesian2D 依赖
	    ...
	    module.exports = ComponentModel.extend({
	        ...
	        /**
	         * @type {module:dcharts/coord/cartesian/Grid}
	         */
	        coordinateSystem: null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var AxisModel = ComponentModel.extend({
	        ...
	        /**
	         * @type {module:dcharts/coord/cartesian/Axis2D}
	         */
	        axis: null,
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     * @param {module:dcharts/model/Component} BaseAxisModelClass
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var AxisView = __webpack_require__(1).extendComponentView({
	        ...
	        /**
	         * @param {module:dcharts/coord/cartesian/AxisModel} axisModel
	         * @param {module:dcharts/coord/cartesian/GridModel} gridModel
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    dcharts.registerLayout(zrUtil.curry(barLayoutGrid, 'bar'));
	    // Visual coding for legend
	    dcharts.registerVisual(function (ecModel) {
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    dcharts.registerVisual(zrUtil.curry(__webpack_require__(143), 'pie'));

	    dcharts.registerLayout(zrUtil.curry(
	        __webpack_require__(144), 'pie'
	    ));

	    dcharts.registerProcessor(zrUtil.curry(__webpack_require__(146), 'pie'));
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * @module dcharts/chart/helper/DataSelectable
	 */
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = function (seriesType, actionInfos) {
	        zrUtil.each(actionInfos, function (actionInfo) {
	             ...
	             */
	            dcharts.registerAction(actionInfo, function (payload, ecModel) {
	                var selected = {};
	                ecModel.eachComponent(
